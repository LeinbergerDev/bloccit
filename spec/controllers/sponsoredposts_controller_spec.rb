...
RSpec.describe SponsoredpostsController, type: :controller do
  ...
  let(:my_sponsoredpost) { my_topic.sponsoredposts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 10) }
  ...
  describe "GET #show" do
    ...
    it "assigns my_sponsoredpost to @spondoredpost" do
      get :show, params: { topic_id: my_topic.id, id: my_sponsoredpost.id }
  ...
  describe "POST create" do
    it "increases the number of Post by 1" do
      expect{ post :create, params: { topic_id: my_topic.id, sponsoredpost: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 10 }}}.to change(Sponsoredpost,:count).by(1)
    end

    it "assigns the new post to @sponsoredpost" do
      post :create, params: { topic_id: my_topic.id, sponsoredpost: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 10 } }
  ...
  describe "PUT update" do
    ...
    it "redirects to the udated post" do
      new_title = RandomData.random_sentence
      new_body = RandomData.random_paragraph
      new_price = 100
      put :update, params: {topic_id: my_topic.id, id: my_sponsoredpost.id, sponsoredpost: {title: new_title, body: new_body, price: new_price}}
