...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  describe "POST #create" do
    it "increases the number of advertisement by 1" do
      expect{ advertisement :create, params: { advertisement: { title: RandomData.random_sentence, copy: RandomData.random_paragraph, price: 10 }}}.to change(Advertisement, :count).by(1)
    end

    it "assigns the new advertisement to @advertisement" do
      advertisement :create, params: { advertisement: { title: RandomData.random_sentence, copy: RandomData.random_paragraph, price: 10}}
